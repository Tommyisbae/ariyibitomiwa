...
const PROJECTS = [
  {
    ...
    title: "Voiceflow",
    description:
      "End-to-end UI design and custom Webflow development for a B2B SaaS platform.",
  ...
  },
  {
    ...
    title: "Climb",
    description:
      "End-to-end UI design and scalable design system for a Databricks-native AI consultancy, delivered on an aggressive timeline.",
  ...
  },
  {
    ...
    title: "Intryc AI",
    description:
      "End-to-end UI design and custom Webflow development, delivering a high-performance platform that drives engagement.",
  ...
  },
  {
    ...
    title: "Mono AI",
    description:
      "From concept to live site—seamless UI/UX design and Webflow engineering bringing clarity to complex AI workflows.",
  ...
  },
  {
    ...
    title: "Tandem",
    description:
      "Pixel-perfect web design paired with flawless Webflow execution to bridge an ambitious brand vision.",
  ...
  },
  {
    ...
    description:
      "Comprehensive UX design and scalable Webflow development transitioning a DTC consultant into a strategic institution.",
  ...
  },
  {
    ...
    title: "Haven Oaks",
    description:
      "End-to-end product design and robust Webflow architecture for an accessible, trust-driven care platform.",
    ...
    <div className="min-h-screen bg-white relative">
      ...
      <main className="max-w-[620px] mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-16">
          ...
          {activeTab === "About" && (
            <section className="space-y-16 text-[16px] text-[#4A4A4A] leading-relaxed">
              <div className="space-y-4">
                <h3 className="text-[12px] font-medium text-[#A0A0A0] uppercase tracking-wider mb-2">
                  Summary
                </h3>
                <p>
                  For the last 3+ years, I've been obsessed with one thing:
                  building high-performance Webflow sites that win you business.
                  I bridge the gap between stunning design (Figma) and flawless
                  technical execution (Webflow). I specialize in turning slow,
                  clunky brochure sites into strategic digital experiences that
                  turn clicks into customers. I work fully remotely, partnering
                  with ambitious brands worldwide.
                </p>
                <div className="pt-2 flex items-center gap-4">
                  <a
                    href="https://www.linkedin.com/in/ariyibi-tomiwa-668219212"
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 px-3 py-1.5 bg-[#F2F2F1] hover:bg-[#E5E5E4] transition-colors rounded-[8px] text-[14px] text-black font-medium"
                  >
                    <span className="text-white bg-[#0A66C2] px-1 py-0.5 rounded-[4px] text-[10px] font-bold leading-none flex items-center shrink-0">
                      IN
                    </span>
                    LinkedIn CV
                  </a>
              ...
              <div className="space-y-4">
                ...
                <p>
                  I recently worked with AssetIntel, a US-based infrastructure
                  asset management firm, to engineer robust and scalable web
                  solutions. Prior to that, as a Web Developer at Brandsmits and
                  Murals.ng, I designed and developed high-performance Webflow
                  sites across diverse industries. Throughout my workflow, I
                  specialize in converting complex Figma designs into
                  pixel-perfect architecture using Finsweet's Client First
                  system.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p>
                  I'm a Webflow Certified Partner and Framer Expert. My
                  technical stack focuses heavily on JavaScript, Framer Motion,
                  and the GreenSock Animation Platform (GSAP). I regularly
                  develop custom solutions integrating third-party robust setups
                  like Wized, Xano, and Memberstack to meet and surpass
          ...
          {activeTab === "Contact" && (
            <section className="animate-in fade-in slide-in-from-bottom-2 duration-500">
              <h3 className="text-[12px] font-medium text-[#A0A0A0] uppercase tracking-wider mb-6">
                Contact
              </h3>
              <div className="flex flex-col gap-4">
                <a
                  href="mailto:ariyibitomiwa611@gmail.com"
                  className="flex items-center gap-3 text-[#0066CC] hover:text-black transition-colors text-[15px] sm:text-[18px] w-fit break-all"
                >
                ...
                <a
                  href="https://contra.com/ariyibi_tomiwa/work"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 text-[#0066CC] hover:text-black transition-colors text-[15px] sm:text-[18px] w-fit break-all"
                >
          ...
          <section className="grid sm:grid-cols-2 gap-6 pt-16">
            {(activeTab === "Work" || activeTab === "About") && (
              ...
              >
                <span className="text-[14px] text-gray-500 mb-2 font-normal">
                  Get In Touch
                </span>
        ...
        <footer className="mt-20 pt-8 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-500 relative z-10">
          ...
          <a
            href="mailto:ariyibitomiwa611@gmail.com"
            className="hover:text-black mt-2 sm:mt-0 transition-colors"
          >
            ariyibitomiwa611@gmail.com
          </a>
        </footer>
